...
export const MetricsFooter = ({ schemas, tables, columns, indexes, warnings }: MetricsFooterProps) => (
  <footer className="border-t border-slate-200 bg-white px-6 py-3 text-xs font-medium text-slate-600">
    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="inline-flex items-center gap-2">
        ...
        <span>
          Avisos: <span className="font-semibold text-amber-600">{warnings}</span>
        </span>
      </div>
    </div>
    <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] font-normal text-slate-500 sm:justify-end">
      <a href="/termos.html" target="_blank" rel="noreferrer" className="hover:text-brand-600">
        Termos de Uso
      </a>
      <span aria-hidden="true">•</span>
      <a href="/privacidade.html" target="_blank" rel="noreferrer" className="hover:text-brand-600">
